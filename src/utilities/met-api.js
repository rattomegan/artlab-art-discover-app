...
// export async function fetchItemsWithParameters(searchTerm, parameterName, firstIndex) {
//   console.log(`https://collectionapi.metmuseum.org/public/collection/v1/search?${parameterName}=true&q=${searchTerm}`)
//   const res  = await fetch(`https://collectionapi.metmuseum.org/public/collection/v1/search?${parameterName}=true&q=${searchTerm}`).then(res => res.json())
//   const objectIDs = res.objectIDs.splice(firstIndex, 30)
//   const promiseArray = objectIDs.map((id) => {
//     return fetch(`https://collectionapi.metmuseum.org/public/collection/v1/objects/${id}`).then(res => res.json())
//   })
